...
async def test_saga_rollback(mock_session_factory):
    ...
    assert not step2.compensated # Failed step usually doesn't need compensation if it didn't complete, or depends on logic. Here we compensate *completed* steps.
