...
class TestResourceState:
    def test_resource_state_creation(self):
        ...
        state = ResourceState(id="vm-001", type="compute", config={"cpu": 2, "memory": "4GB"})
...
class TestPlan:
    ...
    def test_plan_with_creates(self):
        ...
        resource = ResourceDefinition(
            name="test-vm", type="compute", provider="fake", specs={"cpu": 2}
        )
    ...
    def test_plan_with_updates(self):
        ...
        desired = ResourceDefinition(
            name="vm-001", type="compute", provider="fake", specs={"cpu": 4}
        )
