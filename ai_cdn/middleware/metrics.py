"""Prometheus metrics collection for AI-CDN."""
...
http_request_size_bytes = Histogram(
    'aicdn_http_request_size_bytes',
    'HTTP request size in bytes',
    ['method', 'endpoint']
)

http_response_size_bytes = Histogram(
    'aicdn_http_response_size_bytes',
...
llm_requests_total = Counter(
    'aicdn_llm_requests_total',
    'Total LLM requests',
    ['operation', 'status']
)

llm_tokens_generated = Counter(
    'aicdn_llm_tokens_generated_total',
...
blueprint_operations_total = Counter(
    'aicdn_blueprint_operations_total',
    'Total blueprint operations',
    ['operation', 'status']
)
...
deployment_operations_total = Counter(
    'aicdn_deployment_operations_total',
...
active_connections = Gauge(
    'aicdn_active_connections',
    'Number of active connections'
)

database_connections = Gauge(
    'aicdn_database_connections',
...
class MetricsCollector:
    """
    Centralized metrics collector for AI-CDN.
    ...
    def record_blueprint_operation(
        ...
        """
        blueprint_operations_total.labels(
            operation=operation,
            status=status
        ).inc()
...
def get_metrics_collector() -> MetricsCollector:
    ...
    if _metrics_collector is None:
        ...
        app_info.info({
            'version': '0.1.0',
            'name': 'AI-CDN',
            'description': 'Infrastructure as Conversation'
        })
